            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", gap: "13px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "row", gap: "16px" }}>
                {[
                  ...
                  >
                    <div 
                      className="relative w-full h-full flex flex-col transition-transform duration-500 ease-[cubic-bezier(0.33,1,0.68,1)] group-hover:-translate-y-full"
                    >
                      <div className="flex-shrink-0 w-full h-full flex justify-center items-center text-[#B2B2B2] transition-transform duration-500 ease-[cubic-bezier(0.33,1,0.68,1)] group-hover:translate-x-[-10px] group-hover:rotate-[-15deg]">
                        {social.icon}
                      </div>
                      <div className="flex-shrink-0 w-full h-full flex justify-center items-center text-[#DA5932] translate-x-[10px] rotate-[15deg] transition-transform duration-500 ease-[cubic-bezier(0.33,1,0.68,1)] group-hover:translate-x-0 group-hover:rotate-0">
                        {social.icon}
                      </div>
                    </div>
                  </a>
